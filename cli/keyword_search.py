...
class InvertedIndex:
    ...
    def get_tf(self, doc_id: int, term: str) -> int:
        ...
        if len(tokens) != 1:
            raise ValueError(f"Expected 1 token, but found {len(tokens)} for term '{term}'")
        token = tokens[0]
    ...
    def get_bm25_tf(self, doc_id, term, k1=BM25_K1, b=BM25_B):
        ...
        return (tf * (k1 + 1)) / (tf + k1 * ((1 - b) + b * (self.doc_lengths[doc_id] / self.__get_avg_doc_length())))
